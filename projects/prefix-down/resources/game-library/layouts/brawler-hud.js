...
export function createBrawlerHud(scene) {
  ...
  const portrait = scene.add.sprite(72, 86, "ash-idle", 0).setScale(1.8).setScrollFactor(0).setDepth(3002);
  ...
  const name = scene.add.text(130, 56, HERO.name.toUpperCase(), { ...clearStyle("#e8dcc8", 26), fontStyle: "700" }).setScrollFactor(0).setDepth(3002);
