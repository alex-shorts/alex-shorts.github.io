...
media:
  - file: media/headstone-olivewood-2016.jpg
    kind: headstone
    shared: true
    tags: [olivewood-t-2-1, nelson_b_parsons, harriet_b_foss_parsons]
    appears: [nelson_b_parsons, harriet_b_foss_parsons]
    ...
    note: "Inscription OCR — PARSONS / NELSON B. 1863—1931 / HARRIET B. 1873—1941."
  - file: media/marriage-1899-face.png
    kind: document
    shared: true
    tags: [marriage-1899, nelson_b_parsons, harriet_b_foss_parsons]
    appears: [nelson_b_parsons, harriet_b_foss_parsons]
  ...
  - file: media/marriage-1899-parents-side.png
    ...
    captured_at: 2026-08-07
    note: "On this film the parents card is the image *before* the face card."
---
## Summary
...
| --- | --- | --- |
| Stone | PARSONS / NELSON B. / 1863—1931 (left) | Dual headstone OCR |
| Plot | Olivewood T-2-1-5 | FAG |
| m. | 23 Feb 1899 Fort Fairfield; res. Mars Hill; starch mfr | ME VR face |
