...
parents: [albert_m_fife, josephine_fife]
parent_links:
  - id: albert_m_fife
    confidence: Probable
  - id: josephine_fife
    confidence: Probable
spouses: [theodore_m_orciere]
...
Mother of **Marion Orciere**. **C470 / C472 Locked** (Marcy via Alex 2026-08-07). Crestlawn with spouse **Theodore M. Orciere**. Maiden **G** still unknown on free sources.

## Assertions

| Claim | Confidence | Source | Source URL | Notes |
| --- | --- | --- | --- | --- |
| Identity Rachel G. Orciere 1904–1997 Crestlawn | Confirmed | FAG 203880996 + Marcy | https://www.findagrave.com/memorial/203880996/rachel-g-orciere | Pack **C472** |
| Spouse Theodore M. Orciere | Confirmed | FAG + Marcy | Same | Pack **C472** |
| Mother of Marion Orciere | Confirmed | Marcy via Alex 2026-08-07 |  | Pack **C470** |
| Maiden surname | — | Not on free FAG | — | Open |
...
- Maiden / parents; other children; census households (FS/Ancestry login)
---
