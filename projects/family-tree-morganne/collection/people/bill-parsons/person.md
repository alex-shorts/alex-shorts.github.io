...
media:
  - file: media/portrait-1973.jpg
    ...
    note: "Brewers waist-up glove pose with facsimile signature. Person-card portrait; also stands in for 1973 Jewel Foods Brewers promo (FT-0006)."
  - file: media/1971-brewers-picture-pack-6.jpg
    kind: photo
    gallery: baseball-cards
    ...
    captured_at: 2026-08-07
    note: "1971 Brewers Picture Pack #6 face cropped from auction sheet; B&W team-issue portrait."
  - file: media/1972-topps-281.jpg
    ...
    captured_at: 2026-08-07
    note: "RC / Topps 1971 All-Star Rookie trophy. Fair research capture for private family archive; see FT-0006."
  - file: media/1972-topps-281-autograph.jpg
    ...
    captured_at: 2026-08-07
    note: "Same 1972 Topps #281 design; Almanac hosts as autograph image."
  - file: media/1972-kelloggs-5.png
    ...
    captured_at: 2026-08-07
    note: "1972 Kellogg's 3-D Super Stars #5 front (XOGRAPH; cracked lenticular typical of set)."
  - file: media/1972-kelloggs-5-back.png
    ...
    source_url: https://www.number5typecollection.com/2012/02/1972-kelloggs-baseball-5-bill-parsons.html
    captured_at: 2026-08-07
    note: "Card back — William Raymond Parsons; NO. 05 OF 54; 1971 stats."
  - file: media/1973-topps-231.jpg
    ...
    captured_at: 2026-08-07
    note: "Brewers home action (#52); FT-0006."
  - file: media/1973-topps-231-back.jpg
    ...
    captured_at: 2026-08-07
    note: "Card back — William Raymond Parsons; stats through 1972."
  - file: media/1974-topps-574.jpg
    ...
    captured_at: 2026-08-07
    note: "Brewers road waist-up; FT-0006."
  - file: media/1975-topps-613.jpg
    ...
    captured_at: 2026-08-07
    note: "Oakland A's portrait; confirms RetroSeasons listing is this pitcher."
  - file: media/career-photo-sabr-as.jpg
    kind: photo
    gallery: career-photos
    source: "SABR BioProject — ParsonsBill / BillParsons.JPG"
    source_url: https://sabr.org/bioproj/person/bill-parsons/
    captured_at: 2026-08-07
    note: "Full-length kneeling A's portrait (career gallery, not a Topps face)."
  - file: media/career-photo-brewerfanatic-portrait.jpg
    ...
    captured_at: 2026-08-07
    note: "Color Brewers headshot (road powder blue)."
  - file: media/career-photo-autograph-disc.jpg
    ...
    source_url: https://brewerfanatic.com/milwaukee-brewers-players-project/bill-parsons-r39/
    captured_at: 2026-08-07
    note: "Vintage Brewers baseball-style disc with handwritten Bill Parsons autograph."
  - file: media/career-photo-crew-throwback.jpg
    ...
    captured_at: 2026-08-07
    note: "Modern commemorative Crew Throwback graphic."
---

## Summary

Father of **Morganne Shorts**; spouse of **Marcy Parsons**. Former MLB pitcher (Milwaukee Brewers 1971–73, Oakland Athletics 1974). **1971 AL Rookie of the Year runner-up** (BBWAA); **The Sporting News AL Rookie Pitcher of the Year**. Person-card portrait from Wikimedia Commons; baseball-card / career galleries linked as **FT-0006**. **1973 OPC #231** still deferred (no hostable distinct face). Living-private genealogy — no public death digs.
...
- Family corroboration (Alex, 2026-08-07) — Morganne Shorts ancestry
- [Wikimedia Commons — Bill Parsons 1973](https://commons.wikimedia.org/wiki/File:Bill_Parsons_1973.jpg)
- [Baseball-Reference — Bill Parsons](https://www.baseball-reference.com/players/p/parsobi01.shtml)
- [SABR — Bill Parsons](https://sabr.org/bioproj/person/bill-parsons/)
- Object **FT-0006** — baseball-card rolodex checklist

## Open questions

- Preferred legal middle documentation vs cemetery forms on parents (Allen / Austin) — see pack **C466**
- **1973 OPC #231** — hostable distinct face still deferred
