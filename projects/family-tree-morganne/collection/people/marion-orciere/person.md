...
Maternal grandmother of Morganne Shorts (mother of Marcy Parsons). **C442** + **C470 Locked**. Soft vitals from SortedByName SSACI (**C477**): **Marian Eveline**, b. **16 Aug 1926** Riverside/Arlington CA; d. **Oct 1976**; Crestlawn as **Marian E Crabtree**. Aka Crabtree / Harris / Rudd (remarriage trail). Parents Theodore × **Rachel G. Fife**. Brother **Kenneth Martin Orciere** soft (**C476**). Not mother of Dan (**C549**). No longer living-private.

## Assertions

| Claim | Confidence | Source | Source URL | Notes |
| --- | --- | --- | --- | --- |
| Mother of Marcy Parsons | Confirmed | Family corroboration |  | **C442** |
| Parents Theodore × Rachel (Fife) Orciere | Confirmed | Marcy + SSACI | https://www.sortedbyname.com/letter_o/orciere.html | **C470** |
| b. 16 Aug 1926; d. Oct 1976; Crestlawn Crabtree | Probable | SSACI + FAG 203881060 | Same + FAG | **C477** awaiting Y |
| Sibling Kenneth Martin Orciere | Probable | SSACI both children | Same | **C476** |
| Not mother of Dan Rudd | Confirmed | Marcy |  | **C549** |

## Sources

- Family corroboration (Marcy via Alex, 2026-08-07)
- [SortedByName — Orciere](https://www.sortedbyname.com/letter_o/orciere.html)
- [Find A Grave 203881060 — Marian E Crabtree](https://www.findagrave.com/memorial/203881060/marian-e-crabtree)
- [Press-Enterprise — George E. Rudd](https://www.pressenterprise.com/obituaries/george-rudd-capistrano-beach-ca/)

## Open questions

- Exact death day in Oct 1976; Crabtree/Harris spouse identities
- Riverside sister of Marcy (**C474**) — not Kenneth (brother); still need name
---
