...
| Attribute | Value | Source | Source URL | Notes |
| --- | --- | --- | --- | --- |
| US Navy | Enlisted; tool designer | FT-0008 / Press-Enterprise obit | https://www.pressenterprise.com/obituaries/george-rudd-capistrano-beach-ca/ | No separate Navy personnel file found open |
| Family market | Corner of 8th & Joy, Corona CA (building remains per obit) | Same | Same | No open contemporary clipping with full text |
| Liquor store | Owned a liquor store (after delivery work from age 10) | Same | Same | |
| Restaurants | The Encore (L.A. Restaurant Row); Jolly Fox Inn; Coachman (Corona/Riverside) | Same | Same | No open full-text newspaper stories naming George; do not mint clipping objects |
